...
package ifneeded cgi 1.1 [list tclPkgSetup $dir cgi 1.1 {{cgi.tcl source {CgiCancel CgiCleanup CgiClose CgiExec CgiHandle CgiRead CgiSpawn Cgi_Directory Cgi_Domain Cgi_Ident Cgi_SetEnv Cgi_SetEnvAll Doc_application/x-cgi}}}]
...
package ifneeded dirlist 1.0 [list tclPkgSetup $dir dirlist 1.0 {{dirlist.tcl source {DateCompare DirList DirlistCompare SizeCompare}}}]
package ifneeded doc 1.1 [list tclPkgSetup $dir doc 1.1 {{doc.tcl source {DocAccept DocCheckTemplate DocChoose DocDirectory DocDomain DocExclude DocFallback DocHandle DocLatest DocMatch DocSubst DocSubstSystemFile DocTemplate Doc_AddRoot Doc_CheckTemplates Doc_Cookie Doc_Dynamic Doc_Error Doc_ErrorPage Doc_ExcludePat Doc_File Doc_IndexFile Doc_IsLinkToSelf Doc_NotFound Doc_NotFoundPage Doc_PublicHtml Doc_Root Doc_SetCookie Doc_Subst Doc_TemplateInterp Doc_TemplateLibrary Doc_Virtual Doc_Webmaster Doc_application/x-imagemap Doc_application/x-tcl-auth Doc_application/x-tcl-subst Doc_application/x-tcl-template Doc_text/html}}}]
package ifneeded html 1.0 [list tclPkgSetup $dir html 1.0 {{html.tcl source {Html_ExtractParam Html_ValueList}}}]
package ifneeded httpd 1.1 [list tclPkgSetup $dir httpd 1.1 {{httpd.tcl source {HttpdAccept HttpdCancel HttpdClose HttpdCopy HttpdCopyDone HttpdDate HttpdPostData HttpdRead HttpdReset HttpdRespondHeader HttpdSetCookie Httpd_Error Httpd_Init Httpd_Peername Httpd_Redirect Httpd_RedirectDir Httpd_RedirectSelf Httpd_RegisterShutdown Httpd_RequestAuth Httpd_ReturnCacheableData Httpd_ReturnData Httpd_ReturnFile Httpd_SelfUrl Httpd_Server Httpd_SetCookie Httpd_Shutdown Httpd_SockClose bgerror}} {version.tcl source Httpd_Version}}]
...
package ifneeded url 1.0 [list tclPkgSetup $dir url 1.0 {{url.tcl source {UrlDecodeData UrlSort Url_Decode Url_DecodeMIMEField Url_DecodeQuery Url_DecodeQuery_application/x-ww-urlencoded Url_DecodeQuery_application/x-www-form-urlencoded Url_DecodeQuery_application/x-www-urlencoded Url_DecodeQuery_multipart/form-data Url_Dispatch Url_Encode Url_Handle Url_PathCheck Url_PrefixInstall Url_Redirect Url_RedirectSelf Url_UnCache}}}]
