...
package ifneeded mail 1.0 [list tclPkgSetup $dir mail 1.0 {{mail.tcl source {Mail/bugreport Mail/formdata Mail/forminfo MailInner Mail_Url}}}]
...
package ifneeded snmp 1.0 [list tclPkgSetup $dir snmp 1.0 {{snmp.tcl source {Doc_application/x-tcl-snmp SnmpDebug SnmpInit SnmpProcess Snmp_DisplayMib Snmp_SessionPage Snmp_Walk Snmp_combo Snmp_discover Snmp_formGroup Snmp_formSession Snmp_host Snmp_hostId Snmp_input Snmp_mibTable Snmp_netId Snmp_radio Snmp_select Snmp_setMib}} {telnet.tcl source {Import_clear Telnet expect mung mung2}} {discover.tcl source {DiscoverCallback MyIpaddr MyNet SnmpDiscover}}}]
package ifneeded srvui 1.0 [list tclPkgSetup $dir srvui 1.0 {{srvui.tcl source SrvUI_Init}}]
package ifneeded status 1.1 [list tclPkgSetup $dir status 1.1 {{status.tcl source {Debug/after Debug/echo Debug/errorInfo Debug/goof Debug/package Debug/parray Debug/raise Debug/source Debug_Url Doc_application/x-tcl-status Status Status/ Status/all Status/codesize Status/datasize Status/doc Status/hello Status/notfound Status/notfound/reset Status/size Status/text StatusMainTable StatusMenu StatusMinuteHist StatusPrintArray StatusPrintHits StatusPrintNotFound StatusSort StatusSortForm StatusSortName StatusTclPower StatusTimeText Status_Url Version}}}]
...
package ifneeded url 1.0 [list tclPkgSetup $dir url 1.0 {{url.tcl source {UrlSort Url_Decode Url_DecodeQuery Url_Dispatch Url_Handle Url_PathCheck Url_PrefixInstall Url_Redirect Url_RedirectSelf Url_UnCache}}}]
